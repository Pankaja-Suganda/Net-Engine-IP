...
#
# Script generated by Vivado on Sat Jul 20 16:33:01 +0530 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : floating_point_mul.sh
...
#
# Usage        : floating_point_mul.sh
#                floating_point_mul.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                floating_point_mul.sh [-reset_run]
#                floating_point_mul.sh [-reset_log]
#                floating_point_mul.sh [-help]
#
...
#                script (type 'floating_point_mul.sh -help' for more information).
#
...
# script info
echo -e "floating_point_mul.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./floating_point_mul.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.floating_point_mul xil_defaultlib.glbl -o floating_point_mul_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./floating_point_mul_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key floating_point_mul_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc floating_point_mul_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./floating_point_mul.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: floating_point_mul.sh [-help]\n\
Usage: floating_point_mul.sh [-step]\n\
Usage: floating_point_mul.sh [-lib_map_path]\n\
Usage: floating_point_mul.sh [-reset_run]\n\
Usage: floating_point_mul.sh [-reset_log]\n\
Usage: floating_point_mul.sh [-keep_index]\n\
Usage: floating_point_mul.sh [-noclean_files]\n\n\
