...
#
# Script generated by Vivado on Sun Jul 07 00:30:19 +0530 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : master_fifo_out.sh
...
#
# Usage        : master_fifo_out.sh
#                master_fifo_out.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                master_fifo_out.sh [-reset_run]
#                master_fifo_out.sh [-reset_log]
#                master_fifo_out.sh [-help]
#
...
#                script (type 'master_fifo_out.sh -help' for more information).
#
...
# script info
echo -e "master_fifo_out.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./master_fifo_out.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.master_fifo_out xil_defaultlib.glbl -o master_fifo_out_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./master_fifo_out_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key master_fifo_out_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc master_fifo_out_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./master_fifo_out.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: master_fifo_out.sh [-help]\n\
Usage: master_fifo_out.sh [-step]\n\
Usage: master_fifo_out.sh [-lib_map_path]\n\
Usage: master_fifo_out.sh [-reset_run]\n\
Usage: master_fifo_out.sh [-reset_log]\n\
Usage: master_fifo_out.sh [-keep_index]\n\
Usage: master_fifo_out.sh [-noclean_files]\n\n\
